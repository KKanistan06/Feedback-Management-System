...
<body>
    ...
    <div class="container">
        <button class="close-button" onclick="window.location.href='feedback.php'">&#10006;</button>
        <h2>Lecturer Feedback Summary</h2>
        <h3>Course: <?php echo htmlspecialchars($courseId); ?> | Lecturer Id: <?php echo htmlspecialchars($lecturerId); ?></h3>
